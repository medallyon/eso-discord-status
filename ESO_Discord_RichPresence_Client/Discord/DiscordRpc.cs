...
public class DiscordRpc
{
    ...
    [DllImport("./win32-dynamic/bin/discord-rpc.dll", EntryPoint = "Discord_Initialize", CallingConvention = CallingConvention.Cdecl)]
    public static extern void Initialize(string applicationId, ref EventHandlers handlers, bool autoRegister, string optionalSteamId);

    [DllImport("./win32-dynamic/bin/discord-rpc.dll", EntryPoint = "Discord_Shutdown", CallingConvention = CallingConvention.Cdecl)]
    public static extern void Shutdown();

    [DllImport("./win32-dynamic/bin/discord-rpc.dll", EntryPoint = "Discord_RunCallbacks", CallingConvention = CallingConvention.Cdecl)]
    public static extern void RunCallbacks();

    [DllImport("./win32-dynamic/bin/discord-rpc.dll", EntryPoint = "Discord_UpdatePresence", CallingConvention = CallingConvention.Cdecl)]
    private static extern void UpdatePresenceNative(ref RichPresenceStruct presence);

    [DllImport("./win32-dynamic/bin/discord-rpc.dll", EntryPoint = "Discord_ClearPresence", CallingConvention = CallingConvention.Cdecl)]
    public static extern void ClearPresence();

    [DllImport("./win32-dynamic/bin/discord-rpc.dll", EntryPoint = "Discord_Respond", CallingConvention = CallingConvention.Cdecl)]
    public static extern void Respond(string userId, Reply reply);

    [DllImport("./win32-dynamic/bin/discord-rpc.dll", EntryPoint = "Discord_UpdateHandlers", CallingConvention = CallingConvention.Cdecl)]
